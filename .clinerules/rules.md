...
For the remainder of M2, apply AGENTS.md's **M2 Stage Workflow — User-Confirmed Override** and use [the M2 completion package](../docs/project/tasks/m2-completion.md) as the active package. This stage-specific rule takes precedence over older per-function handoff instructions.
